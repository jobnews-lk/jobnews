...
import { Landmark, ArrowLeft, Search, FolderOpen, X } from 'lucide-react';
import { supabase, type Job, type Category } from '../lib/supabase';
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Government Jobs</h1>
          </div>
          <p className="text-slate-500 dark:text-slate-400">Public sector, ministries, and civil service vacancy announcements</p>
        </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder="Search government jobs by title, department, or keyword..."
        ...
        {activeFilters.length > 0 && (
          <div className="flex flex-wrap items-center gap-2 mb-6">
            ...
            <button onClick={() => { setSearch(''); setSearchInput(''); setSelectedCategory(''); }} className="text-sm text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 underline">Clear all</button>
          </div>
        )}
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
            <p className="text-lg font-medium text-slate-500 dark:text-slate-400">No government job notices match your search.</p>
          </div>
        ) : (
